...
static char *camera_fixup_getparams(int id, const char *settings)
{
    ...
    ALOGV("%s: rotation=%d, captureMode=%s, videoHdr=%s\n",
          __FUNCTION__, rotation, captureMode, videoHdr);
...
static char *camera_fixup_setparams(int id, const char *settings)
{
    ...
    ALOGV("%s: isVideo=%d, previewSize=%s, sceneMode=%s, videoHdr=%s\n",
          __FUNCTION__, isVideo, previewSize, sceneMode, videoHdr);

    // Enable video mode for our Samsung camera
    //   old overlay: needsSamsungCamMode
