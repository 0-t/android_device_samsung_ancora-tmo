...
PRODUCT_COPY_FILES += \
    ...
    $(LOCAL_PATH)/config/audio_policy.conf:system/etc/audio_effects.conf
...
PRODUCT_COPY_FILES += \
    ...
    $(LOCAL_PATH)/prebuilt/ES_File_Explorer_3.0.7.0.apk:system/app/ES_File_Explorer_3.0.7.0.apk \
