...
COMMON_GLOBAL_CFLAGS += -DQCOM_HARDWARE -DQCOM_ROTATOR_KERNEL_FORMATS -DBINDER_COMPAT -DSAMSUNG_CAMERA_QCOM
...
WIFI_DRIVER_MODULE_ARG           := "iface_name=wlan0 firmware_path=/vendor/firmware/fw_bcmdhd.bin nvram_path=/vendor/firmware/nvram_net.txt"
...
BOARD_VENDOR_QCOM_GPS_LOC_API_HARDWARE := ancora_tmo
