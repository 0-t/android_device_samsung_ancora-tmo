...
PRODUCT_COPY_FILES += \
    ...
    $(LOCAL_PATH)/config/init.ancora_tmo.gps.rc:root/init.ancora_tmo.gps.rc \
    ...
    $(LOCAL_PATH)/prebuilt/ES_File_Explorer_3.1.1.apk:system/app/ES_File_Explorer_3.1.1.apk
...
$(call inherit-product, vendor/samsung/ancora_tmo/device-vendor.mk)
